...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-cfbc25c9.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-3473fecc.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-de0a179a.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-d3d59fbd.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-8aee8c8f.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-e6da6aef.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-b198d8e6.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-0aa2fe10.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-4042e643.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-3068befe.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-507a359d.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-00978d2e.js") })),
  setup({ el, App, props, plugin }) {
    return createApp({ render: () => h$1(App, props) }).use(plugin).use($, Ziggy).mount(el);
  },
  progress: {
    color: "#4B5563"
  }
