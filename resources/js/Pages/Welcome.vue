...
<template>
    ...
    <Page>
        ...
        <div class="mb-10">
            <img src="/img/mft_logo.png" class="mx-auto w-80"/>
        </div>

        <div class="md:grid grid-cols-3 gap-4 mb-8">
            <Link href="/bands" class="rounded-lg bg-gray-800 p-4 hover:bg-gray-700 block mb-6 transition duration-200">
                <h3>Bands</h3>
                <p>Browse bands by name</p>
            </Link>

            <Link href="/cities" class="rounded-lg bg-gray-800 p-4 hover:bg-gray-700 block mb-6 transition duration-200">
                <h3>City</h3>
                <p>Browse bands by city</p>
            </Link>

            <Link href="/genres" class="rounded-lg bg-gray-800 p-4 hover:bg-gray-700 block mb-6 transition duration-200">
                <h3>Genre</h3>
